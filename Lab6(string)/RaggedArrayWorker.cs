...
namespace Lab6
{
    class RaggedComparer : IComparer<int[]>
    {
    ...
    class RaggedArrayWorker
    {
            ...
            while (!shouldExitInMainMenu)
            {
                ...
                if (int.TryParse(Console.ReadLine(), out int command))
                {
                    switch (command)
                    {
                        ...
                        case 4:
                            Console.Clear();
                            RaggedSort(ref raggedTwoDimArray);
                            break;
                        case 5:
        ...
        static void ShowMenu()
        {
            ...
            Console.WriteLine("4. Сортировать массив");
        ...
        static void CreateArray(ref int[][] raggedTwoDimArray)
        {
            ...
            GetCorrectVal("Введите количество строк(1 - 22360): ", "ERROR: неверное количество строк", out int rows, 1, 22360);
        ...
        static void PrintArray(ref int[][] raggedTwoDimArray)
        {
            ...
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("ERROR: Массив пуст!!!\n");
                Console.ResetColor();
                return;
            }
        ...
        static void RaggedSort(ref int[][] raggedTwoDimArray)
        {
            ...
            Console.WriteLine("Массив сортируется...");
            for (int i = 0; i < raggedTwoDimArray.Length; i++)
            {
                Array.Sort(raggedTwoDimArray[i]);
            }

            Array.Sort(raggedTwoDimArray, new RaggedComparer());
            Console.Clear();
        }
    }
}
